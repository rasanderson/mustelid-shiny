...
class SpeciesNetTFInference(BaseClassifierInference):
    ...
    def __init__(self, version='v4.0.0a', run_mode='multi_thread', geofence=True):
        ...
        try:
            ...
            raise ImportError("Install speciesnet: pip install speciesnet") from exc

        self._prepare_instances_dict = prepare_instances_dict
    ...
    def single_image_classification(self, file_path, det_results=None):
        ...
        instances_dict = self._prepare_instances_dict(
            filepaths=[file_path],
        )
